        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                             ...
                                             //   Toast.makeText(Users.this, UserList.get(position).getname()+"", Toast.LENGTH_SHORT).show();
                                                phone=bloodListss.get(position).getPhoneNumber();
                                                name=bloodListss.get(position).getname();

                                               Intent i = new Intent(Users.this, ReviewRequest.class);
                                                i.putExtra("id",id);
                        ...
                        if (resp.equals("[]")) {
                            ...
                            try {
                                ...
                                for (int i = 0; i <= jsonArray.length(); i++) {
                                    ...
                                    list.setid(jsonBlood.getInt("Id"));
                                    id = jsonBlood.getInt("Id");
